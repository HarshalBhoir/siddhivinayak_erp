...
class PWA(Controller):
    ...
    def service_worker(self):
        ...
        content = qweb._render('web_pwa_oca.service_worker', {
    ...
    def manifest(self):
        ...
        pwa_name = config_param.get_param("pwa.manifest.name", "Siddhivinayak ERP")
        pwa_short_name = config_param.get_param("pwa.manifest.short_name", "Siddhivinayak ERP")
        ...
        content = qweb._render('web_pwa_oca.manifest', {
            'pwa_name': pwa_name,
